...
function setPrePageNumSelect(){
	...
	$('#searchBtn').on('click', function(){
		...
		if(!searchTypeVal){
			...
			$searchTypeSel.focus();
			return;
		}else if(!keywordVal || keywordVal < 2){
			alert("검색어는 2자 이상입니다.");
			$('#keyword').focus();
			return;
			...
			<div class="wrap-login100">
				<div class="login100-form">
					...
					<div class="row">
						...
						<div class="col-sm-3">
							<input type="text" class="form-control" id="keyword" name="keyword" value="${pageMaker.cri.keyword}" placeholder="검색어를 입력해 주세요">
						</div>
